...
useradd calos -m -s /bin/bash -p $(openssl passwd -crypt 123) -G GRP_ADM
...
useradd sebastia -m -s /bin/bash -p $(openssl passwd -crypt 123) -G GRP_SEC
useradd rodrigo -m -s /bin/bash -p $(openssl passwd -crypt 123) -G GRP_SEC
